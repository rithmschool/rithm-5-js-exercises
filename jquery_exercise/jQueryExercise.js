$(document).ready(function() {
  ...
  //clicking on favorites button shows only full-star items, hides everything else.
  $("#favoritesLink")
    ...
    //hides list numbers in front of star
    $("#list li").addClass("no-list-numbers");
  ...
  $("#list")
      ...
      $("#list li").toggleClass("no-list-numbers");
      $("#allLink").toggleClass("hidden");
      $("#favoritesLink").toggleClass("hidden");
  ...
  $("#allLink")
    ...
    $("#list li").removeClass("no-list-numbers");
    $("#allLink").toggleClass("hidden");
    $("#favoritesLink").toggleClass("hidden");
  });
